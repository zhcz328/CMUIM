"""
Configuration settings for the CMUIM architecture.
...
class CMUIMConfig:
    """
    Complete configuration for the CMUIM project.
    """
    ...
    @classmethod
    def from_dict(cls, config_dict: Dict[str, Any]) -> 'CMUIMConfig':
        """
...
DEFAULT_CONFIG = CMUIMConfig()


def get_config(config_path: Optional[str] = None) -> CMUIMConfig:
    """
